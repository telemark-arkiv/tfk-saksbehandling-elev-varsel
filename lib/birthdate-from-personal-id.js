...
function birthdateFromPersonalId (id) {
  ...
  var personalYearEnd = parseInt(personalid.substr(4,2))
  var realYearEnd = parseInt(now.getFullYear().toString().substr(2,2))
  var realYearStart = parseInt(now.getFullYear().toString().substr(0,2))
  var birthYear
